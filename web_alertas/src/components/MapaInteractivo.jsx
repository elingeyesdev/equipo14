...
export default function MapaInteractivo({
  ...
  if (!MAPBOX_TOKEN) {
    return (
      <div
        className={`flex items-center justify-center rounded-xl border border-amber-200 bg-amber-50 p-6 text-center text-sm text-amber-900 ${className}`}
      >
        <div>
          <p className="font-semibold mb-1">Falta el token de Mapbox</p>
          <p className="text-xs">
            Agrega <code className="bg-amber-100 px-1 rounded">VITE_MAPBOX_TOKEN</code> en{' '}
            <code className="bg-amber-100 px-1 rounded">web_alertas/.env</code> y reinicia{' '}
