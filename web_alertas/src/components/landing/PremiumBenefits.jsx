            ...
            {features.filter(f => f.size === 'large').map((feat, i) => {
              ...
              return (
                <motion.article
                  ...
                  className="group relative card-premium shimmer-overlay p-7 lg:p-8 overflow-hidden cursor-default min-h-[235px] flex flex-col justify-between"
                >
                  {/* Hover glow bg */}
                  ...
                  <div className="relative z-10 flex flex-col justify-between h-full">
                    <div>
                      ...
                      <h3 className="text-[19px] font-bold text-[var(--ink)] tracking-tight">{feat.title}</h3>
                      <p className="mt-2.5 text-[14.5px] text-[var(--body)] leading-relaxed">{feat.desc}</p>
                    </div>
            ...
            {features.filter(f => f.size === 'normal').map((feat, i) => {
              ...
              return (
                <motion.article
                  ...
                  className="group relative card-premium shimmer-overlay p-6 lg:p-7 overflow-hidden cursor-default min-h-[200px] flex flex-col justify-between"
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none rounded-[1rem]"
                  ...
                  <div className="relative z-10 flex flex-col justify-between h-full">
                    <div>
                      ...
                      <h3 className="text-[16px] font-bold text-[var(--ink)] tracking-tight">{feat.title}</h3>
                      <p className="mt-2 text-[13.5px] text-[var(--body)] leading-relaxed">{feat.desc}</p>
                    </div>
                  </div>
                </motion.article>
              )
